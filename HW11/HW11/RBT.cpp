    ...
    while (point != root && getColor(point->parent) == RED)
    {
        ...
        if (parent == grandparent->left)
        {
            ...
            } else
            {
                ...
                // Case 3: Node is now the left child
                swapColor(parent);
                swapColor(grandparent);
        ...
        {  // parent is the right child of the grandparent
            ...
            } else
            {
                ...
                {
                    singleCR(parent);
                    point = parent;  // Update node to parent after rotation
                    parent = point->parent;  // Update parent to new parent
                }

                // Case 3: Node is now the right child
                swapColor(parent);
                swapColor(grandparent);
